...
package info.ipeanut.youngsamples.third.viewgroup.directionalViewPager;
 ...
 * http://www.tuicool.com/articles/bmiQruY
 * 主要在onInterceptTouchEvent()和onTouchEvent()里面加入了对于垂直方向滑动的支持.并提供了setOrientation()这个方法
 *
 * measure原理
 * http://www.tuicool.com/articles/An6JzaE
 *
...
public class DirectionalViewPager extends ViewPager {
    ...
    public DirectionalViewPager(Context context, AttributeSet attrs) {
        ...
        //看android/widget/LinearLayout.java 的源码  方向的定义值 跟 该类是一样的
        public static final int HORIZONTAL = 0;
        public static final int VERTICAL = 1;
         */
        //拿到的是具有XML_NS命名空间的元素  的 orientation  属性的值
    ...
    void initViewPager() {
        ...
        mMinimumVelocity = configuration.getScaledMinimumFlingVelocity();//Fling速度
