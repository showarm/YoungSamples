...
/**
 * 创建时间: 2018/01/31 18:36 <br>
 * 作者: chenshao <br>
 * 描述:
 */
public class WivDemoActivity extends Activity {

  RecyclerView rv_content;

  @Override protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_wiv_demo);
  ...
  class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
    ...
    @Override public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View view;
      if (viewType == 1) {
        view = View.inflate(WivDemoActivity.this, R.layout.item1, null);
      } else {
        view = View.inflate(WivDemoActivity.this, R.layout.item0, null);
    ...
    @Override public void onBindViewHolder(MyHolder holder, int position) {
      if (position == 9) {
        ...
        //holder.windowImageView.setImageURI(
        //    Uri.parse("http://www.fzlu.net/uploads/allimg/150918/3-15091Q00R2a2.jpg"));
